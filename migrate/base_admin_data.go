...
func BaseAdminData(db *gorm.DB, version string) error {
	return db.Transaction(func(tx *gorm.DB) error {
		list1 := []models.RoleMenu{
			...
			{RoleId: 1, MenuId: 88, RoleName: "admin"},
			...
			{RoleId: 1, MenuId: 98, RoleName: "admin"},
		...
		list2 := []models.CasbinRule{
			...
			{PType: "p", V0: "admin", V1: "/api/v1/menuTree/option", V2: "GET"},
			...
			{PType: "p", V0: "admin", V1: "/api/v1/user/info", V2: "GET"},
			...
			{PType: "p", V0: "admin", V1: "/api/v1/roles/enable/:id", V2: "PATCH"},
			{PType: "p", V0: "admin", V1: "/api/v1/roles/disable/:id", V2: "PATCH"},
		...
		list8 := []models.User{
			{1, models.SuperRoot, "$2a$10$cKFFTCzGOvaIHHJY2K45Zuwt8TD6oPzYi4s5MzYIBAWCLL6ZhouP2", "root", "18888888888", "", "", "0", "root@qq.com", "0", "", 1, 1, 1, "1", "1", models.Model{}, "", ""},
			{2, models.SuperAdmin, "$2a$10$cKFFTCzGOvaIHHJY2K45Zuwt8TD6oPzYi4s5MzYIBAWCLL6ZhouP2", "zhangwj", "18888888888", "", "", "0", "admin@qq.com", "0", "", 1, 1, 1, "1", "1", models.Model{}, "", ""},
		}
